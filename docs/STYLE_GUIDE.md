...
- Senior-coworker register. Like the ISSO sitting next to you who says "let me explain this" before walking into the topic. Patient, knowing, occasionally wry. Not a textbook. Not a marketing illustration.
...
- First-person occasional. *"This is what tripped me up the first time I saw an SSP."* Use sparingly. First-person is a flavor, not a frame.
